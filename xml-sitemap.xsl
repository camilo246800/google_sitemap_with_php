		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					<h1>XML Sitemap</h1>
					<p class="expl">
						Generado por <a href="http://yoast.com/xml-sitemap-php-script/">XML Sitemap PHP Script</a>, by <a href="#">Camilo Camargo</a> este es un mapa del sitio XML, destinado al consumo de los motores de búsqueda.<br/>
						Más información sobre sitemaps en <a href="http://sitemaps.org">sitemaps.org</a>.
					</p>					
